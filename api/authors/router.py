...
async def list_authors(
    ...
    if isFavorite is not None and not isFavorite:
        query = query.filter(not AuthorModel.is_favorite)
    if isFavorite is not None and isFavorite:
        query = query.filter(AuthorModel.is_favorite)
    return query.all()
