...
- ✅ 2023/09: 重複検出機能（aHash、閾値score<10）
- ✅ 2024/01: お気に入り機能
- ✅ 2025/08: テーブル名リファクタリング
- ✅ 2026/02/10: Memory Bank初期化 + 包括的コードレビュー完了
- ✅ 2026/02/10: リファクタリング実施
  - フェーズ1: 非破壊的変更（`purser.py` → `parser.py`等）
  - フェーズ2: Pydanticスキーマのエイリアス対応
  - フェーズ4: 追加の命名規則統一
  - フェーズ5: エンドポイント関数名の改善（RESTful命名規則に準拠）
