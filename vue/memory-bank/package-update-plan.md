...
#### 🔴 高リスク: メジャーバージョン更新（破壊的変更の可能性大）

| パッケージ | 現在 | 最新 | リスク評価 |
|-----------|------|------|-----------|
| **vite** | 5.4.21 | 7.3.1 | ⚠️ 非常に高 - ビルドツールのコア |
| **vue-router** | 4.6.4 | 5.0.2 | ⚠️ 高 - ルーティング変更の可能性 |
| **pinia** | 2.3.1 | 3.0.4 | ⚠️ 高 - 状態管理のコア |
| **@vitejs/plugin-vue** | 5.2.4 | 6.0.4 | ⚠️ 高 - Vite連携 |
| **vue-tsc** | 2.2.12 | 3.2.4 | ⚠️ 中 - 型チェック |
| **eslint** | 9.39.2 | 10.0.0 | ⚠️ 中 - リンター設定変更 |
| **eslint-plugin-vue** | 9.33.0 | 10.7.0 | ⚠️ 中 - Vue lintルール |
| **@eslint/js** | 9.39.2 | 10.0.1 | ⚠️ 中 - ESLint連携 |
| **unplugin-auto-import** | 0.17.8 | 21.0.0 | ⚠️ 中 - 自動インポート |
| **unplugin-vue-components** | 0.27.5 | 31.0.0 | ⚠️ 中 - コンポーネント自動登録 |
| **npm-run-all2** | 7.0.2 | 8.0.4 | ⚠️ 低 - ビルドスクリプト |
| **@types/node** | 22.19.7 | 25.2.2 | ⚠️ 低 - 型定義のみ |

#### 🟡 中リスク: マイナー・パッチバージョン更新

| パッケージ | 現在 | 最新 | タイプ |
|-----------|------|------|--------|
| **sass** | 1.77.8 | 1.97.3 | マイナー |
| **typescript** | 5.6.3 | 5.9.3 | マイナー |
| **openapi-fetch** | 0.13.8 | 0.16.0 | マイナー |
| **openapi-typescript** | 7.10.1 | 7.12.0 | マイナー |
| **unplugin-vue-router** | 0.10.9 | 0.19.2 | マイナー |
| **@vue/tsconfig** | 0.5.1 | 0.8.1 | マイナー |
